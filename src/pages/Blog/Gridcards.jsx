...
const Gridcards = () => {
  return (
    ...
    <div className="text-[#170f49] font-[DM Sans, sans-serif] text-base leading-5 box-border md:grid grid-cols-2 gap-x-7 gap-y-7">
      {/* first card */}
      <div className="max-w-sm mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl m-5 hover:cursor-pointer">
      ...
      <div className="md:flex-col p-8">
        ...
        <div className="p-8">
          ...
          <div className="tracking-wide text-lg text-[#493f8c]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</div>
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mt-4 px-4 rounded-full">
          Read More
          </button>
        </div>
      </div>
